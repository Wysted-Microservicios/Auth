...
func (o *RecoveryCode) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryCockroachDB(dialect, "\"recovery_codes\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return fmt.Errorf("models: unable to upsert recovery_codes: %w", err)
	}
